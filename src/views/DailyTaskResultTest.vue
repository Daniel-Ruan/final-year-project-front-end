...
const createDailyTask = async () => {
    ...
    modalEmitter.emit('call-confirm-modal', {
        ...
        onModalConfirm: async() => {
            ...
            const info = await dailyTaskStore.postDailyTask(longTaskStore.currentLongTask.id, DailyTaskName.value, dateformater.value, dailyGoalNumber.value, GenerateNewCategoryQuestionList.value.toString())
            ...
            if (info == 'ok') {
                ...
                router1.push({ path: `/longTasks/${longTaskStore.currentLongTask.id}`})
            }
...
<div class="antialiased text-gray-700 bg-gray-100 rounded-l-[45px]">
                ...
                <h1 class="font-bold text-5xl text-center text-indigo-700">
                    ...
                    <div>
                        ...
                        <div class="flex justify-start space-x-4 mt-6">
                            ...
                            <p class="text-2xl">
                                Wrong Answers:
                                <span class="text-3xl text-red-700 font-bold"
                                    >{{ wrongAnswer }}</span
                                >
                            </p>
                        </div>
